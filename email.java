...
public class Message{
	...
	public void email(String recpeint, String sender, String messageText){
		sender = sender;
		recpeint = recpeint;
		messageText = messageText;
	}
	
	public void messageText(String add){
		newMessage = messageText + add;
		
	}
	
	public void print(){
		System.out.println("Sender: " + sender + " Recipeint: " + recpeint);
